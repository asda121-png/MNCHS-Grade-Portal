...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .profile-form { background:white; padding:2rem; border-radius:16px; box-shadow:var(--shadow); max-width:1000px; border-left:5px solid var(--accent); }
        ...
        .form-group input { padding:12px 15px; border:1px solid #ddd; border-radius:8px; font-family:'Poppins',sans-serif; font-size:1rem; transition:var(--transition); background-color:#f9fafb; }
