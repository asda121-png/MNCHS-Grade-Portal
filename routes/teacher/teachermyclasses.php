...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .btn-view { background:var(--primary); color:white; padding:8px 15px; border-radius:8px; text-decoration:none; font-weight:500; transition:var(--transition); display:inline-block; }
    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li><a href="teachermyclasses.html" class="active"><i class="fas fa-users"></i> My Classes</a></li>
            ...
            <table class="classes-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col-center"><a href="teachergradeentry.html?class=11-STEM-A" class="btn-view">View Class</a></td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-center"><a href="teachergradeentry.html?class=11-STEM-B" class="btn-view">View Class</a></td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-center"><a href="teachergradeentry.html?class=12-HUMSS-A" class="btn-view">View Class</a></td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-center"><a href="teachergradeentry.html?class=12-ABM-C" class="btn-view">View Class</a></td>
                    </tr>
                </tbody>
            </table>
        </main>
