            ...
            <table class="classes-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col-center"><a href="teachergradeentry.php?class=11-STEM-A" class="btn-view">View Class</a></td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-center"><a href="teachergradeentry.php?class=11-STEM-B" class="btn-view">View Class</a></td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-center"><a href="teachergradeentry.php?class=12-HUMSS-A" class="btn-view">View Class</a></td>
                    </tr>
                    <tr>
                        ...
                        <td class="col-center"><a href="teachergradeentry.php?class=12-ABM-C" class="btn-view">View Class</a></td>
                    </tr>
                </tbody>
            </table>
        </main>
