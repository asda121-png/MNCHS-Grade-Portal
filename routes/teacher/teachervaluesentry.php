...
<body>
    ...
    <header class="header">
        <h1><i class="fas fa-heart"></i> MNCHS Grade Portal</h1>
        <div class="user-info">
            <a href="#" class="notification-bell"><i class="fas fa-bell"></i><span class="notification-badge">3</span></a>
    ...
    <div class="container">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li><a href="teachervaluesentry.html" class="active"><i class="fas fa-tasks"></i> Values Entry</a></li>
